...
insert into pedido (id, codigo,entrega_agendada, entrega_agendada_para, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                  status, data_criacao, subtotal, tx_frete, valor_total)
values (1, 'f9981ca4-5a5e-4da3-af04-933861df3e55',0, utc_timestamp, 1, 6, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo,entrega_agendada, entrega_agendada_para, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                  status, data_criacao, subtotal, tx_frete, valor_total)
values (2, 'd178b637-a785-4768-a3cb-aa1ce5a8cdab',0, utc_timestamp, 4, 6, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
...
values (3, 'b5741512-8fbc-47fa-9ac1-b530354fc0ff',0, utc_timestamp, 1, 7, 1, 1, '38400-222', 'Rua Natal', '200', null, 'Brasil',
...
insert into pedido (id, codigo,entrega_agendada, entrega_agendada_para, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                  status, data_criacao, data_confirmacao, data_entrega, subtotal, tx_frete, valor_total)
values (4, '5c621c9a-ba61-4454-8631-8aabefe58dc2',0, utc_timestamp, 1, 7, 1, 1, '38400-800', 'Rua Fortaleza', '900', 'Apto 504', 'Centro',
...
insert into pedido (id, codigo,entrega_agendada, entrega_agendada_para, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                  status, data_criacao, data_confirmacao, data_entrega, subtotal, tx_frete, valor_total)
values (5, '8d774bcf-b238-42f3-aef1-5fb388754d63',0, utc_timestamp, 1, 3, 2, 1, '38400-200', 'Rua 10', '930', 'Casa 20', 'Martins',
