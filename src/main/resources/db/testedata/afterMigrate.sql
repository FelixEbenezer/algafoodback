...
insert into restaurante (id, nome, tx_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep) values (2, 'Thai Delivery', 9.50, 1, utc_timestamp, utc_timestamp, true, true, 1, '51100');
insert into restaurante (id, nome, tx_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep) values (3, 'Tuk Tuk Comida Indiana', 15, 2, utc_timestamp, utc_timestamp, true, true, 2, '51-100');
insert into restaurante (id, nome, tx_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep) values (4, 'Java Steakhouse', 12, 3, utc_timestamp, utc_timestamp, true, true, 3, '75-280');
insert into restaurante (id, nome, tx_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep) values (5, 'Lanchonete do Tio Sam', 11, 4, utc_timestamp, utc_timestamp, true, true, 4, '75-650');
insert into restaurante (id, nome, tx_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep) values (6, 'Bar da Maria', 6, 4, utc_timestamp, utc_timestamp, true, true, 3, 'LD12-455');
...
insert into restaurante_usuario_responsavel (restaurante_id, usuario_id) values (1, 5), (3, 5), (6,5), (2,2), (2,1), (4,2), (5,1);
...
insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
    ...
    status, data_criacao, data_entrega, subtotal, tx_frete, valor_total)
values (1,'8511fd72-6e9e-11ea-bc55-0242ac130003', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
'CRIADO', utc_timestamp,utc_timestamp, 298.90, 10, 308.90);
